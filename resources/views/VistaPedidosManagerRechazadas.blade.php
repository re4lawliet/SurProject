...
<link rel="stylesheet" type="text/css" href="http://cdn.datatables.net/1.10.12/css/jquery.dataTables.min.css">
    <center>
        ...
        <div class="panel-title">
            <h1><center>VISTA DE SOLICITUDES RECHAZADAS</center></h1>
        </div>
        ...
        <div class="col-md-12">
            ...
            @if (count($querySolicitudes) > 0)
                ...
                <div class="panel-body">
                    <table id="solicitudes_manager" class="table table-striped task-table">
                        <!-- Encabezado de Tabla -->
                        <thead>
                        ...
                        @foreach ($querySolicitudes as $solicitud)
                            <tr>
                                ...
                                <!-- Boton VER -->
                                <td>
                                    <button type="submit" class="btn btn-primary" onclick="location.href='SolicitudSinBoton/{{ $solicitud->id }}/{{ $solicitud->nombre }}/{{ $solicitud->nombre_proyecto }}'">
