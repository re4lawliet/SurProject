...
@section('content')
        ...
        <form id="crear_orden_frm" action="{{ url('OrdenCreadaRechazada') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <input id="txtTotal" type="hidden" name="txt_total" class="form-control" >
                                <input id="txtTotal_show" type="text" name="txt_total_show" class="form-control" >
                            </div>
                        </div>
                        <!-- Fin del Contenido -->
                    </div> 
...
<script>
    $(document).ready(function() {
        ...
        location.href='/OrdenSolicitudRechazada/{{Session::get('s_id')}}/'+val_id_partida+'/'+val_id_proyecto+'/'+val_id_proveedor;
        });
    });
</script>
<script>
